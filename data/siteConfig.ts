...
export const siteConfig = {
  ...
  eventNames: {
    ...
    quoteWorkspaceViewed: "quote_workspace_viewed",
    quoteWorkspaceStarted: "quote_workspace_started",
    quoteWorkspaceCompleted: "quote_workspace_completed",
...
export const navLinks = [
  ...
  { href: "/quote-workspace", label: "Workspace" },
